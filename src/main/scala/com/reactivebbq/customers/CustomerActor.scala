...
class CustomerActor extends PersistentActor with ActorLogging {
  ...
  override def receiveRecover: Receive = {
    ...
    case AddOrder(customerId, orderId) => addOrder(customerId, orderId)
  ...
  override def receiveCommand: Receive = {
    ...
    case GetCustomer(customerId) => sender ! getCustomer(customerId)
    ...
    case GetAllOrders(customerId) => sender ! getOrders(customerId)
